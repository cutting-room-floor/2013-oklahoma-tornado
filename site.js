...
for ( var i = 0; i < geoJson.length; i++ ){
    ...
    var marker = L.marker([coords[1], coords[0]], {
        ...
        icon: L.divIcon({
            ...
            html: '<img src="http://mapbox-raster.s3.amazonaws.com/oklahoma-tornado/src/browse/' + feature.properties.entity_id + '.jpg">',
    ...
    var popupContent = '<a target="_blank" class="popup" href="http://mapbox-raster.s3.amazonaws.com/oklahoma-tornado/src/full/' + feature.properties.entity_id + '.jpg">' +
                            '<img src="http://mapbox-raster.s3.amazonaws.com/oklahoma-tornado/src/browse/' + feature.properties.entity_id + '.jpg">'
                        '</a>';
...
addLayer(tornado1990,'May 3, 1999 tornado path');
